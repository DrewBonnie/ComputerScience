...
int main(int argc, char **argv) {
    ...
    //new colors
    double neonPurple[] =       {200,  50, 250,  0.2,  0.8,    0, 0.02};
    double ivory[] =            {230, 230, 200,    0,    0, 0.13,  0.1};
    double mintGreen[] =        {199, 255, 199, 0.22,    0, 0.22,    0};
    ...
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test_prestate(testBidirectionalValues, &neonPurple),
            cmocka_unit_test_prestate(testBidirectionalValues, &ivory),
            cmocka_unit_test_prestate(testBidirectionalValues, &mintGreen)
  };
